...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # 4. Write an "if" statement that checks that the county does not match existing county.
...
with open(file_to_save, "w") as txt_file:
    ...
    # 6a/b/c/: Write a for loop to get the county from the county dictionary.
    for county in county_votes:
        ...
        # 6 f Determine winning vote count.
